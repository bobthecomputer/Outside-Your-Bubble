...
import type { SwipeAction } from "@/lib/deck";
import { defaultPartnerCodes, listBetaPartners } from "@/lib/partners";

type DeckMode = "discover" | "study" | "professional" | "random";
...
type LearningStepStatus = "pending" | "seen" | "done" | "skipped";

type LearningArticleStep = {
  id: string;
  kind: "article";
  itemId: string;
  title: string;
...
type LearningStep = LearningArticleStep | LearningQuizStep;
...
const ACTION_COPY: Record<SwipeAction, { label: string; icon: ReactNode }> = {
...
function AchievementToastStack({ toasts, dismiss }: { toasts: AchievementToast[]; dismiss: (id: string) => void }) {
  return (
    <div
            ...
            {loading ? (
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  {(Object.keys(ACTION_COPY) as SwipeAction[]).map((action) => (
